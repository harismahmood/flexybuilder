@if (!Session::has('script'))
    ...
    <body id="builder">
    <div class="loading">
        <div class="animated fadeIn infinite"><img src="{{ url('img/loading.png') }}"
        ...
        <div class="container-center">
            <div id="topbar-builder">
                ...
                <div class="topbar-builder-center">
                    <i onclick="canvasDesktop()" class="fa fa-laptop pointer" title="Desktop Viewport"></i>
                    <i onclick="canvasTablet()" class="fa fa-tablet pointer" title="Tablet Viewport"></i>
                    <i onclick="canvasMobile()" class="fa fa-mobile pointer" title="Mobile Viewport"></i>
                </div>
                <div class="right">
                    <i class="pointer fa fa-cog"></i>
                </div>
            </div>
            <div id="container-canvas-center">
                <div id="columns-canvas-center">
                    <div id="layouts"></div>
                    <div id="canvas">
                        <div id="canvas-header" onmouseenter="showLabel('canvas-header','Header')"
                             onmouseleave="removeLabel()">
                        </div>

                        <div onmouseenter="showLabel('canvas-center','Main Content')" onmouseleave="removeLabel()"
                             id="canvas-center">
                          <div class="row">
                              <div class="col-xs-12 col-sm-3 col-md-3"><h1 class="black-text">Hello!</h1></div>
                              <div class="col-xs-12 col-sm-3 col-md-3"><h1 class="black-text">Hello!</h1></div>
                              <div class="col-xs-12 col-sm-3 col-md-3"><h1 class="black-text">Hello!</h1></div>
                              <div class="col-xs-12 col-sm-3 col-md-3"><h1 class="black-text">Hello!</h1></div>
                          </div>
                        </div>
                        <div id="canvas-footer" onmouseenter="showLabel('canvas-footer','Footer')"
                             onmouseleave="removeLabel()">
                        </div>
                    </div>
                </div>
            ...
            <script src="{{ url('js/steps.js') }}"></script>
